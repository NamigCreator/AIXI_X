...
from data_utils import CTBrainDataModule
...
class Model(LightningModule):
    ...
    def predict_step(self, batch, batch_idx, mask_size=16):
        x_true, edges, target, name = batch
    ...
    def _log_collage(self, results, mask_sizes, folder):
        for name in results:
            fig, ax = plt.subplots(5, len(mask_sizes), figsize=(24, 24))
